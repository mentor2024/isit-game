...
export default async function LevelUpPage({
    ...
    // Service Role Client for Metrics (Bypasses RLS)
    // We use this because getting the user's own score might be blocked by restrictive RLS policies
    // and we want to ensure accurate reporting regardless of client-side visibility rules.
