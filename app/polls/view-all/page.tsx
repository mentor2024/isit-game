...
export default function PollsViewAll() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const { data, error } = await supabase.rpc('admin_poll_meta_all');
  ...
  return (
    <div className="p-4 md:p-6">
      <h1 className="text-xl font-semibold mb-3">All polls (read-only)</h1>
