...
export default function LevelEditorForm({
    ...
    return (
        <form action={handleSubmit} className="text-left max-w-2xl mx-auto">
            {/* Instructions */}
            <div className="mb-8">
                <label className="block text-lg font-bold mb-2">Level Up Instructions</label>
                <textarea
                    name="instructions"
                    defaultValue={initialConfig?.instructions || ""}
                    className="w-full h-32 p-4 border-2 border-gray-300 rounded-xl focus:border-black outline-none transition-colors"
                    ...
                    <div className="p-4 bg-white rounded-xl border border-green-200 shadow-sm relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="md:col-span-2">
                                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Feedback Message</label>
                                <textarea
                                    name="tier_a_message"
                                    defaultValue={initialConfig?.score_tiers?.[0]?.message || "Outstanding! You are in Group A."}
                    ...
                    <div className="p-4 bg-white rounded-xl border border-yellow-200 shadow-sm relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    name="tier_b_message"
                                    defaultValue={initialConfig?.score_tiers?.[1]?.message || "Good effort. You are in Group B."}
                                    className="w-full p-2 border border-gray-300 rounded h-16 text-sm"
                    ...
                    <div className="p-4 bg-white rounded-xl border border-gray-200 shadow-sm relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    name="tier_c_message"
                                    defaultValue={initialConfig?.score_tiers?.[2]?.message || "Needs improvement. You are in Group C."}
                                    className="w-full p-2 border border-gray-300 rounded h-16 text-sm"
