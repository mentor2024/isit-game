...
function FeedbackEditor({ name, defaultValue, placeholder, variant = "simple", heightClass }: { name: string, defaultValue: string, placeholder?: string, variant?: 'default' | 'simple', heightClass?: string }) {
